...
export class ActionSuggestionService implements IActionSuggestionService {
    ...
    for (const prog of progress) {
      if (prog.status === 'EXCEEDED' || prog.status === 'CRITICAL') {
        ...
        suggestions.push({
          ...
          description: `Cần giảm ₫${(overageAmount / 100).toLocaleString('vi-VN')} để giữ ngân sách`,
          impact: 'POSITIVE',
          estimatedResult: `Tiết kiệm ₫${(overageAmount / 100).toLocaleString('vi-VN')}`,
          difficulty: 'MEDIUM',
        ...
        suggestions.push({
          ...
          description: `Còn ₫${(remainingBudget / 100).toLocaleString('vi-VN')} cho tháng này`,
          impact: 'NEUTRAL',
          estimatedResult: `Dự phòng ₫${(remainingBudget / 100).toLocaleString('vi-VN')}`,
          difficulty: 'EASY',
  ...
  async suggestSpendingReduction(
    ...
    suggestions.push({
      ...
      impact: 'POSITIVE',
      estimatedResult: `Tiết kiệm ₫${(targetReduction / 100).toLocaleString('vi-VN')}`,
      difficulty: 'MEDIUM',
      category: categoryName,
    ...
    suggestions.push({
      ...
      impact: 'POSITIVE',
      estimatedResult: `Tiết kiệm ₫${((targetReduction * 0.8) / 100).toLocaleString('vi-VN')}`,
      difficulty: 'MEDIUM',
      category: categoryName,
    ...
    suggestions.push({
      ...
      impact: 'POSITIVE',
      estimatedResult: `Tiết kiệm ₫${((targetReduction * 0.6) / 100).toLocaleString('vi-VN')}`,
      difficulty: 'HARD',
      category: categoryName,
  ...
  async suggestRevenueIncrease(
    ...
    suggestions.push({
      ...
      impact: 'POSITIVE',
      estimatedResult: `Cần tăng doanh thu ₫${(revenueGap / 100).toLocaleString('vi-VN')}`,
      difficulty: 'HARD',
